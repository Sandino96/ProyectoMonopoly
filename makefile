...
railway.o:	railway.cpp railway.h properties.h
	g++ -c railway.cpp

services.o:	services.cpp services.h properties.h
	g++ -c services.cpp
...
jail.o: jail.cpp jail.h square.h
	g++ -c jail.cpp

chance.o: chance.cpp chance.h square.h
	g++ -c chance.cpp

tax.o:	tax.cpp tax.h square.h
	g++ -c tax.cpp

community.o:	community.cpp community.h square.h
	g++ -c community.cpp
